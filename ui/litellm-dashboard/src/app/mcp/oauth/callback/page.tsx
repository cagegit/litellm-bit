  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-6">
      <div className="max-w-lg w-full rounded-lg bg-white shadow-md p-8 text-center space-y-4">
        <h1 className="text-xl font-semibold text-slate-900">{t("litellmMcpOauth")}</h1>
        <p className="text-sm text-slate-700">
          {t("authorizationCompleteYouMayCloseThisWindowAndReturnToTheLitellmDashboard")}
        </p>
        <p className="text-xs text-slate-500">
          {t("ifTheWindowDoesNotCloseAutomaticallyEverythingIsStillSavedYouCanCloseItManually")}
        </p>
      </div>
    </div>
  );
