      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center gap-2">
          <Checkbox checked={comparison.applyAcrossModels} onChange={(e) => handleSyncChange(e.target.checked)}>
            <span className="text-xs font-medium">{t("syncSettingsAcrossModels")}</span>
          </Checkbox>
        </div>
        ...
        {/* General Settings */}
        <div>
          <h4 className="text-xs font-semibold text-gray-700 mb-1.5 uppercase tracking-wide">{t("generalSettings")}</h4>
          <div className="space-y-2">
            <div>
            ...
            <div>
              <label className="text-xs font-medium text-gray-600 block mb-0.5">{t("vectorStores")}</label>
              <VectorStoreSelector
        ...
        {/* Advanced Settings */}
        <div>
          <h4 className="text-xs font-semibold text-gray-700 mb-1.5 uppercase tracking-wide">{t("advancedSettings")}</h4>
          <div className="space-y-2">
            <div className="flex items-center gap-2 pb-1">
              ...
              >
                <span className="text-sm font-medium">{t("useAdvancedParameters")}</span>
              </Checkbox>
            </div>
            <div className="space-y-2 transition-opacity duration-200" style={{ opacity: disabledOpacity }}>
              ...
              <div>
                <div className="flex items-center justify-between mb-1">
                  <label className={`text-xs font-medium ${disabledTextColor}`}>{t("maxTokens")}</label>
