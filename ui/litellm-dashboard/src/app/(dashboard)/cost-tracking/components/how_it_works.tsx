...
const HowItWorks: React.FC = () => {
    ...
    <div className="space-y-4 pt-2">
      <div>
        ...
        <Text className="text-xs text-gray-600">
          {t("discountsAreAppliedToProviderCosts")}{" "}
      ...
      <div>
        ...
        <Text className="text-xs text-gray-600">{t("a5DiscountOnA1000RequestResultsIn10001005950")}</Text>
      </div>
      <div>
        <Text className="font-medium text-gray-900 text-sm mb-1">{t("validRange")}</Text>
        <Text className="text-xs text-gray-600">{t("discountPercentagesMustBeBetween0And100")}</Text>
      </div>

      <div className="pt-4 border-t border-gray-200">
        <Text className="font-medium text-gray-900 text-sm mb-2">{t("validatingDiscounts")}</Text>
        <Text className="text-xs text-gray-600 mb-3">
          {t("makeATestRequestAndCheckTheResponseHeadersToVerifyDiscountsAreApplied")}
        </Text>
        <CodeBlock
          language="bash"
  ...
  -d '{
    ...
    "messages": [{"role": "user", "content": "Hello"}]
        ...
        />
        <Text className="text-xs text-gray-600 mt-3 mb-2">{t("lookForTheseHeadersInTheResponse")}</Text>
      ...
      <div className="pt-4 border-t border-gray-200">
        ...
        <Text className="text-xs text-gray-600 mb-3">{t("enterValuesFromYourResponseHeadersToVerifyTheDiscount")}</Text>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          <div>
            <label className="block text-xs font-medium text-gray-700 mb-1">
              {t("responseCostXLitellmResponseCost")}
            </label>
            <TextInput
          ...
          <div>
            <label className="block text-xs font-medium text-gray-700 mb-1">
              {t("discountAmountXLitellmResponseCostDiscountAmount")}
            </label>
            <TextInput
