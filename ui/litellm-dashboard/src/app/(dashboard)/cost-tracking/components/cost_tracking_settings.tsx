  ...
  return (
    <div className="w-full p-8">
                  ...
                  <TabPanel>
                    <div className="p-6">
                      <div className="flex justify-end mb-4">
                        <Button onClick={() => setIsModalVisible(true)}>{t("addProviderDiscount1")}</Button>
                      </div>
                      {isFetching ? (
                        ...
                        <div className="py-16 px-6 text-center">
                          ...
                          <Text className="text-gray-500 text-sm">
                            {t("clickQuotAddProviderDiscountQuotToGetStarted")}
                          </Text>
                        </div>
                      )}
                    </div>
        ...
        {isProxyAdmin && (
          <Accordion>
            ...
            <AccordionBody className="px-0">
              <div className="p-6">
                <div className="flex justify-end mb-4">
                  <Button onClick={() => setIsMarginModalVisible(true)}>{t("addProviderMargin1")}</Button>
                </div>
                {isFetching ? (
                  <div className="py-12 text-center">
                    <Text className="text-gray-500">{t("loadingConfiguration")}</Text>
                  ...
                  <div className="py-16 px-6 text-center">
                    ...
                    <Text className="text-gray-500 text-sm">{t("clickQuotAddProviderMarginQuotToGetStarted")}</Text>
                  </div>
                )}
              </div>
            </AccordionBody>
      ...
      >
        <div className="mt-6">
          <Text className="text-sm text-gray-600 mb-6">
            {t("selectAProviderAndSetItsDiscountPercentageDescription")}
          </Text>
      ...
      >
        <div className="mt-6">
          <Text className="text-sm text-gray-600 mb-6">
            {t("selectAProviderOrGlobalAndConfigureTheMarginDescription")}
          </Text>
