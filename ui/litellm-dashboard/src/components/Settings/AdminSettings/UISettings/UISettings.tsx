...
export default function UISettings() {
  ...
  const handleToggle = (checked: boolean) => {
    updateSettings(
      ...
      {
        onSuccess: () => {
          NotificationManager.success(t("uiSettingsUpdated"));
        },
        onError: (error) => {
  ...
  const handleUpdatePageVisibility = (settings: { enabled_ui_pages_internal_users: string[] | null }) => {
    updateSettings(settings, {
      onSuccess: () => {
        NotificationManager.success(t("pageVisibilityUpdated"));
      },
      onError: (error) => {
        NotificationManager.fromBackend(error);
      },
  ...
  const handleToggleEnableProjectsUI = (checked: boolean) => {
    updateSettings(
      ...
      {
        onSuccess: () => {
          NotificationManager.success(t("uiSettingsUpdatedWithRefresh"));
  ...
  return (
    <Card title={t("uiSettings")}>
      {isLoading ? (
        <Skeleton active />
      ) : isError ? (
        <Alert
          type="error"
          message={t("couldNotLoadUISettings")}
        ...
        <Space direction="vertical" size="large" style={{ width: "100%" }}>
          ...
          {updateError && (
            <Alert
              type="error"
              message={t("couldNotUpdateUISettings")}
          ...
          <Space align="start" size="middle">
            <Switch
              ...
              aria-label={property?.description ?? t("disableModelAdd")}
            />
            <Space direction="vertical" size={4}>
              <Typography.Text strong>{t("disableModelAdd")}</Typography.Text>
          ...
          <Space align="start" size="middle">
            <Switch
              ...
              aria-label={disableTeamAdminDeleteProperty?.description ?? t("disableTeamAdminDelete")}
            />
            <Space direction="vertical" size={4}>
              <Typography.Text strong>{t("disableTeamAdminDelete")}</Typography.Text>
          ...
          <Space align="start" size="middle">
            <Switch
              ...
              aria-label={requireAuthForPublicAIHubProperty?.description ?? t("requireAuthForPublicAIHub")}
            />
            <Space direction="vertical" size={4}>
              <Typography.Text strong>{t("requireAuthForPublicAIHub")}</Typography.Text>
          ...
          <Space align="start" size="middle">
            <Switch
              ...
              aria-label={forwardClientHeadersProperty?.description ?? t("forwardClientHeaders")}
            />
            <Space direction="vertical" size={4}>
              <Typography.Text strong>{t("forwardClientHeaders")}</Typography.Text>
              <Typography.Text type="secondary">
                {forwardClientHeadersProperty?.description ?? t("forwardClientHeadersDescription")}
              </Typography.Text>
            </Space>
          </Space>
          ...
          <Space align="start" size="middle">
            <Switch
              ...
              aria-label={forwardLLMProviderAuthHeadersProperty?.description ?? t("forwardLLMProviderAuthHeaders")}
            />
            <Space direction="vertical" size={4}>
              <Typography.Text strong>{t("forwardLLMProviderAuthHeaders")}</Typography.Text>
              <Typography.Text type="secondary">
                {forwardLLMProviderAuthHeadersProperty?.description ?? t("forwardLLMProviderAuthHeadersDescription")}
              </Typography.Text>
            </Space>
          </Space>
          ...
          {enableProjectsUIProperty && (
            <Space align="start" size="middle">
              <Switch
                ...
                aria-label={enableProjectsUIProperty.description ?? t("enableProjects")}
              />
              <Space direction="vertical" size={4}>
                <Typography.Text strong>{t("enableProjectsWithRefresh")}</Typography.Text>
                <Typography.Text type="secondary">
                  {enableProjectsUIProperty.description ?? t("enableProjectsDescription")}
                </Typography.Text>
              </Space>
            </Space>
          )}
          ...
          <Space align="start" size="middle">
            <Switch
              ...
              aria-label={disableAgentsProperty?.description ?? t("disableAgents")}
            />
            <Space direction="vertical" size={4}>
              <Typography.Text strong>{t("disableAgents")}</Typography.Text>
          ...
          <Space align="start" size="middle" style={{ marginLeft: 32 }}>
            <Switch
              ...
              aria-label={allowAgentsTeamAdminsProperty?.description ?? t("allowAgentsForTeamAdmins")}
            />
            <Space direction="vertical" size={4}>
              <Typography.Text strong type={!isAgentsDisabled ? "secondary" : undefined}>
                {t("allowAgentsForTeamAdmins")}
              </Typography.Text>
          ...
          <Space align="start" size="middle">
            <Switch
              ...
              aria-label={disableVectorStoresProperty?.description ?? t("disableVectorStores")}
            />
            <Space direction="vertical" size={4}>
              <Typography.Text strong>{t("disableVectorStores")}</Typography.Text>
          ...
          <Space align="start" size="middle" style={{ marginLeft: 32 }}>
            <Switch
              ...
              aria-label={allowVectorStoresTeamAdminsProperty?.description ?? t("allowVectorStoresForTeamAdmins")}
            />
            <Space direction="vertical" size={4}>
              <Typography.Text strong type={!isVectorStoresDisabled ? "secondary" : undefined}>
                {t("allowVectorStoresForTeamAdmins")}
              </Typography.Text>
          ...
          <Space align="start" size="middle">
            <Switch
              ...
              aria-label={scopeUserSearchProperty?.description ?? t("scopeUserSearchToOrg")}
            />
            <Space direction="vertical" size={4}>
              <Typography.Text strong>{t("scopeUserSearchToOrg")}</Typography.Text>
              <Typography.Text type="secondary">
                {scopeUserSearchProperty?.description ?? t("scopeUserSearchToOrgDescription")}
              </Typography.Text>
            </Space>
          </Space>
          ...
          <Space align="start" size="middle">
            <Switch
              ...
              aria-label={disableCustomApiKeysProperty?.description ?? t("disableCustomApiKeys")}
            />
            <Space direction="vertical" size={4}>
              <Typography.Text strong>{t("disableCustomApiKeys")}</Typography.Text>
              <Typography.Text type="secondary">
                {disableCustomApiKeysProperty?.description ?? t("disableCustomApiKeysDescription")}
              </Typography.Text>
            </Space>
          </Space>
