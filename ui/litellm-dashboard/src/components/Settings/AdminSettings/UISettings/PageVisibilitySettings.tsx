  ...
  return (
    <Space direction="vertical" size="middle" style={{ width: "100%" }}>
      <Space direction="vertical" size={4}>
        <Space align="center">
          <Typography.Text strong>{t("internalUserPageVisibility")}</Typography.Text>
          {!isPageVisibilitySet && (
            <Tag color="default" style={{ marginLeft: "8px" }}>
              {t("notSetAllPagesVisible")}
            </Tag>
          )}
          {isPageVisibilitySet && (
      ...
      <Collapse
        items={[
          {
            key: "page-visibility",
            label: t("configurePageVisibility"),
            children: (
              <Space direction="vertical" size="middle" style={{ width: "100%" }}>
