...
export default function SSOSettings() {
  ...
  const renderSimpleValue = (value?: string | null) =>
    value ? value : <span className="text-gray-400 italic">{t("notConfigured")}</span>;
  ...
  const providerConfigs = {
    google: {
      ...
      fields: [
        ...
        { label: t("proxyBaseUrl"), render: (values: SSOSettingsValues) => renderSimpleValue(values.proxy_base_url) },
      ],
    },
    microsoft: {
            ...
            <Space direction="vertical" size="large" className="w-full">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <Title level={3}>{t("ssoConfiguration")}</Title>
                    <Text type="secondary">{t("manageSSOAuthSettings")}</Text>
                  </div>
                </div>
