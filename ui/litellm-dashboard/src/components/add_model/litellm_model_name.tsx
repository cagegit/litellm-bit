...
const LiteLLMModelNameField: React.FC<LiteLLMModelNameFieldProps> = ({
  ...
  return (
    <>
      <Form.Item label={t("liteLLMModelName")} tooltip={t("liteLLMModelNameTooltip")} className="mb-0">
        <Form.Item
          name="model"
          rules={[
            {
              required: true,
              message: selectedProvider === Providers.Azure ? t("enterDeploymentName") : t("enterAtLeastOneModel"),
            },
          ]}
          noStyle
        >
          ...
          selectedProvider === Providers.Ollama ? (
            ...
            <AntSelect
              ...
              options={[
                ...
                {
                  label: t("allModelsWildcard", { provider: selectedProvider }),
                  value: "all-wildcard",
                },
            ...
            return (
              modelArray.includes("custom") && (
                <Form.Item
                  ...
                  rules={[{ required: true, message: t("enterCustomModelName") }]}
                  className="mt-2"
                >
                  <TextInput
                    placeholder={
                      selectedProvider === Providers.Azure ? t("enterAzureDeploymentName") : t("enterCustomModelName")
                    }
      ...
      <Row>
        ...
        <Col span={14}>
          <Text className="mb-3 mt-1">
            {selectedProvider === Providers.Azure ? t("azureDeploymentNameDescription") : t("modelNameDescription")}
          </Text>
        </Col>
      </Row>
    </>
