  ...
  return (
    <div>
      <div className="flex items-center mb-2">
        ...
        <Text className="text-gray-500 font-medium">{t("filterByCategory")}</Text>
      </div>
      <Select
        mode="multiple"
        placeholder={t("selectCategoriesToFilter")}
        style={{ width: "100%" }}
        onChange={onChange}
    ...
    <div className="bg-gray-50 p-5 rounded-lg mb-6 border border-gray-200 shadow-sm">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center">
          ...
          <Tooltip title={t("applyActionToAllPii")}>
  ...
  return (
    <div className="border rounded-lg overflow-hidden shadow-sm">
      ...
      <div className="max-h-[400px] overflow-y-auto">
        {entities.length === 0 ? (
          <div className="py-10 text-center text-gray-500">{t("noPiiMatchFilter")}</div>
        ) : (
          entities.map((entity) => (
            <div
              key={entity}
