...
export const columns = (
      ...
      <Space direction="vertical" size={8}>
        <Flex align="center" gap={8}>
          <Space direction="vertical">
            ...
            <Text type="secondary">{t("reusableDescription")}</Text>
          </Space>
        </Flex>
        <Divider size="small" />
        <Flex align="center" gap={8}>
          <Space direction="vertical" size={8}>
            ...
            <Text type="secondary">{t("manualDescription")}</Text>
          </Space>
        </Flex>
      </Space>
    </Space>
  ...
  return [
    {
      header: () => <span className="text-sm font-semibold">{t("modelId")}</span>,
    ...
    {
      header: () => <span className="text-sm font-semibold">{t("modelInformation")}</span>,
          ...
          <Space direction="vertical" size={12} style={{ minWidth: 220 }}>
            <Flex align="center" gap={8}>
              ...
              <Text type="secondary" style={{ fontSize: 12 }} ellipsis>
                {model.provider || t("unknownProvider")}
              </Text>
            </Flex>
    ...
    {
      header: () => <span className="text-sm font-semibold">{t("createdBy")}</span>,
        ...
        return (
          <div className="flex flex-col min-w-0 w-full">
            ...
            <div
              ...
              title={isConfigModel ? t("definedInConfig") : createdBy || t("unknown")}
            >
              {isConfigModel ? t("definedInConfig") : createdBy || t("unknown")}
            </div>
            {/* Created At - Secondary */}
            <div
              className="text-xs text-gray-500 truncate mt-0.5"
              title={isConfigModel ? t("configFile") : createdAt || t("unknownDate")}
            >
              {isConfigModel ? "-" : createdAt || t("unknownDate")}
            </div>
          </div>
        );
      },
    ...
    {
      header: () => <span className="text-sm font-semibold">{t("updatedAt")}</span>,
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return (
          <Tooltip title={t("costPer1MTokens")}>
            <div className="flex flex-col min-w-0 w-full">
              {/* Input Cost - Primary */}
              {inputCost != null && (
    ...
    {
      header: () => <span className="text-sm font-semibold">{t("teamId")}</span>,
    ...
    {
      header: () => <span className="text-sm font-semibold">{t("modelAccessGroup")}</span>,
    ...
    {
      header: () => <span className="text-sm font-semibold">{t("status")}</span>,
      ...
      cell: ({ row }) => {
        ...
        `}
          >
            {model.model_info.db_model ? t("dbModel") : t("configModel")}
          </div>
        );
      },
    },
    {
      ...
      cell: ({ row }) => {
        ...
        const pauseTooltip = isConfigModel
          ? t("pauseConfigModelTooltip")
          : !isAdmin
            ? t("pauseAdminOnlyTooltip")
            : isBlocked
              ? t("resumeTooltip")
              : t("pauseTooltip");
          ...
          <div className="flex items-center justify-end gap-2 pr-4">
            <Tooltip title={pauseTooltip}>
              <Switch
                ...
                loading={isPausing}
                aria-label={isBlocked ? t("resumeModel") : t("pauseModel")}
                onClick={(_, e) => {
                  e.stopPropagation();
                }}
            ...
            {isConfigModel ? (
              <Tooltip title={t("deleteConfigModelTooltip")}>
