          ...
          <div className="flex flex-wrap items-center gap-1">
            {displayTags.map((tag, index) => (
              <Tooltip
                ...
                title={
                  <div>
                    <div>
                      <span className="text-gray-300">{t("tagName")}</span> {tag.tag}
                    </div>
                    <div>
                      <span className="text-gray-300">{t("spendLabel")}</span>{" "}
            ...
            {hasMoreTags && (
              <button
                ...
                title={isExpanded ? t("showFewerTags") : t("showAllTags")}
              >
                {isExpanded ? (
                ...
                <div className="relative z-50 p-3 bg-black/90 shadow-lg rounded-lg text-white max-w-xs">
                  <div className="space-y-1.5">
                    <div className="text-sm">
                      <span className="text-gray-300">{t("keyAliasLabel")}</span>{" "}
                      <span className="font-mono text-gray-100 break-all">{item?.key_alias}</span>
                    </div>
                    <div className="text-sm">
                      <span className="text-gray-300">{t("keyIdLabel")}</span>{" "}
