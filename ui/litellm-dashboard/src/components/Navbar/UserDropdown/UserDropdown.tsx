    ...
    <Space direction="vertical" size="small" style={{ width: "100%", padding: "12px" }}>
      <Space style={{ width: "100%", justifyContent: "space-between" }}>
        ...
        {premiumUser ? (
          ...
          <Tooltip title={t("upgradeToPremium")} placement="left">
      ...
      <Space style={{ width: "100%", justifyContent: "space-between" }}>
        <Space>
          <UserOutlined />
          <Text type="secondary">{t("userId")}</Text>
        </Space>
      ...
      <Divider style={{ margin: "8px 0" }} />
      <Space style={{ width: "100%", justifyContent: "space-between" }}>
        <Text type="secondary">{t("hideNewFeatureIndicators")}</Text>
        <Switch
          size="small"
          ...
          aria-label={t("toggleHideNewFeatureIndicators")}
        />
      </Space>
      <Space style={{ width: "100%", justifyContent: "space-between" }}>
        <Text type="secondary">{t("hideAllPrompts")}</Text>
        <Switch
          size="small"
          ...
          aria-label={t("toggleHideAllPrompts")}
        />
      </Space>
      <Space style={{ width: "100%", justifyContent: "space-between" }}>
        <Text type="secondary">{t("hideUsageIndicator")}</Text>
        <Switch
          size="small"
          ...
          aria-label={t("toggleHideUsageIndicator")}
        />
      </Space>
      <Space style={{ width: "100%", justifyContent: "space-between" }}>
        <Text type="secondary">{t("hideBlogPosts")}</Text>
        <Switch
          size="small"
          ...
          aria-label={t("toggleHideBlogPosts")}
        />
      </Space>
      <Space style={{ width: "100%", justifyContent: "space-between" }}>
        <Text type="secondary">{t("hideBouncingIcon")}</Text>
        <Switch
          size="small"
          ...
          aria-label={t("toggleHideBouncingIcon")}
        />
      </Space>
    </Space>
  );
