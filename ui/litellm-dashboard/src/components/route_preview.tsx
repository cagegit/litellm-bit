  ...
  return (
    <Card className="p-5">
      ...
      <div className="space-y-5">
        {/* Basic routing */}
        <div>
          <div className="text-base font-semibold text-gray-900 mb-3">{t("basicRouting")}</div>
          <div className="flex items-center gap-4">
            {/* Your endpoint */}
            <div className="flex-1 bg-gray-50 border border-gray-200 rounded-lg p-3">
              <div className="text-sm text-gray-600 mb-2">{t("yourEndpoint")}</div>
            ...
            {/* Forwards to */}
            <div className="flex-1 bg-gray-50 border border-gray-200 rounded-lg p-3">
              <div className="text-sm text-gray-600 mb-2">{t("forwardsTo")}</div>
        ...
        {includeSubpath && (
          <>
            {/* With subpaths */}
            <div>
              <div className="text-base font-semibold text-gray-900 mb-3">{t("withSubpaths")}</div>
              <div className="flex items-center gap-4">
                {/* Your endpoint + subpath */}
                <div className="flex-1 bg-gray-50 border border-gray-200 rounded-lg p-3">
                  <div className="text-sm text-gray-600 mb-2">{t("yourEndpointSubpath")}</div>
              ...
              {/* Note */}
              <div className="mt-3 text-sm text-gray-600">{t("pathAppendedNote", { path: pathValue })}</div>
            </div>
          </>
        )}
          ...
          <div className="mt-4 p-3 bg-blue-50 rounded-md border border-blue-200">
            <div className="flex items-start">
              ...
              <div className="text-sm text-blue-700">
                <span className="font-medium">{t("notSeeingRouting")}</span> {t("tryEnablingSubpaths")}{" "}
                <code className="bg-blue-100 px-1 py-0.5 rounded font-mono text-xs">/api/v1/models</code>{" "}
                {t("forwardedAutomatically")}
              </div>
            </div>
          </div>
        )}
