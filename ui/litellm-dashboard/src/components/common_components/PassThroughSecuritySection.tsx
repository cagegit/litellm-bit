...
const PassThroughSecuritySection: React.FC<PassThroughSecuritySectionProps> = ({
  ...
  return (
    <Card className="p-6">
      ...
      <Subtitle className="text-gray-600 mb-4">{t("passThroughSecurityDescription")}</Subtitle>
      {premiumUser ? (
        ...
        <div>
          <div className="flex items-center mb-3">
            ...
            <span className="ml-2 text-sm text-gray-400">{t("authenticationPremium")}</span>
          </div>
          <div className="p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
            <Text className="text-sm text-yellow-800">
              {t("passThroughSecurityEnterpriseMessage")}
