  ...
  return [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        if (!teamId) {
          return <span className="text-gray-400 text-sm">{t("none")}</span>;
        }
        ...
        return (
          <div className="flex items-center space-x-2">
            ...
            {hasSuccessResponse && showSuccessModal && (
              <Tooltip title={t("viewResponseDetails")} placement="top">
                <button
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        if (!healthStatus?.error) {
          return <Text className="text-gray-400 text-sm">{t("noErrors")}</Text>;
        }
        ...
        return (
          <div className="flex items-center space-x-2">
            ...
            {showErrorModal && fullError !== cleanedError && (
              <Tooltip title={t("viewFullErrorDetails")} placement="top">
                <button
      ...
      cell: ({ row }) => {
        ...
        return (
          <Text className="text-gray-600 text-sm">
            {model.health_loading ? t("checkInProgress") : model.last_check}
          </Text>
        );
      },
    },
    {
      header: t("lastSuccess"),
      ...
      cell: ({ row }) => {
        ...
        const modelId = model.model_info?.id ?? "";
        const healthStatus = modelHealthStatuses[modelId];
        const lastSuccess = healthStatus?.lastSuccess || t("none");
