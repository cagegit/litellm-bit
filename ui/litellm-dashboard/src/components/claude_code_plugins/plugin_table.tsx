...
const PluginTable: React.FC<PluginTableProps> = ({
  ...
  const columns: ColumnDef<Plugin>[] = [
    ...
    },
    {
      ...
      accessorKey: "version",
      cell: ({ row }) => {
        const version = row.original.version || t("na");
    ...
    },
    {
      ...
      cell: ({ row }) => {
        const description = row.original.description || t("noDescription");
        return (
